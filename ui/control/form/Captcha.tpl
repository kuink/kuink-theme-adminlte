<div class="controls">
  ...
  <a href="#" onclick="document.getElementById('img{$fieldID}').src = 'lib/tools/securimage/securimage_show.php?' + Math.random(); return false"><i class="icon icon-refresh"></i></a>
  <br/>
